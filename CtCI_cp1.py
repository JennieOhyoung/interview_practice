...
#1.8 Assume you have a method isSubstring which cheks if one word is a substring of another. Given two strings s1 s2, write code to check if s2 is a rotation of s1 using only one call to isSubstring ( waterbottle is rotation of erbottlewat)
